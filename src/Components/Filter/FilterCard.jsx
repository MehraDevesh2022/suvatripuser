    ...
    <div>
      {hotelData && hotelData.length > 0 ? (
        ...
        hotelData.map((hotel) => (
          ...
          <div
            key={hotel._id["$oid"]}
            className="w-full md:w-[800px] h-auto my-0 bg-[#fff] border-[1px] shadow-lg mx-auto flex flex-col md:flex-row justify-start p-2 rounded-lg"
          >
            ...
            <div className="p-2 w-full md:w-[200px] border-l-[1px] border-slate-400 py-5 px-2">
              ...
              <div style={containerStyle}>
                <h3
                  style={containerStyle}
                  className="text-[24px] text-slate-600 font-[900]"
                >
                  {hotel.currency} {hotel.price}
                </h3>
                <div style={containerStyle}>
                  <p style={containerStyle} className="mb-0 text-[20px]">
                    + {hotel.taxesAndFees} Taxes & Fee
                  </p>
                  <p style={containerStyle} className="mb-0 text-[16px]">
                    Per Night
                  </p>
                </div>
              </div>
