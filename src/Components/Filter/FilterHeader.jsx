...
function FilterHeader() {
    ...
    return (
        <div>
            <div className='w-full xl:w-[1100px] mx-auto flex flex-col md:flex-row justify-between items-center mt-10 mb-1 p-3'>
                <h3 className='text-[22px] md:text-[35px] font-[700] md:font-[800]'>Showing Properties in {location || "Nepal"}</h3>
