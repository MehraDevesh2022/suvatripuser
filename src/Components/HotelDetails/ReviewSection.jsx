...
function ReviewSection({ country, propertyName, username, user_id, review }) {
            ...
            <div className="flex flex-row justify-start items-start">
              ...
              <div className="mx-1">
                ...
                <p className="mb-0">
                  ...
                  <span className="mx-0 md:mx-1 text-[12px] md:text-sm font-[500]">
                    United Kingdom
                  </span>
                </p>
              </div>
          ...
          <div className="w-full mb-0">
            ...
            <div className="mb-0">
              <p className="mb-2">
                ...
                --Beautiful hotel with high standard with heart of Krakow Lorem
                ipsum, dolor sit amet consectetur adipisicing elit. Aliquid
                nobis id saepe eligendi accusantium nisi nemo esse eveniet ipsum
                unde?
              </p>
              <p className="mb-0">
                <span>
                ...
                consequuntur modi impedit quo suscipit quam aperiam architecto
                accusamus optio vel?
              </p>
            </div>
          </div>
