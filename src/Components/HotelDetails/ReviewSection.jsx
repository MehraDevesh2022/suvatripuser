                ...
                <div className='flex flex-row justify-start items-start'>
                    <div className='w-[400px]'>
                        <div className='flex flex-row justify-start items-center'>
                            <div className='w-[45px] h-[45px] rounded-full bg-red-500 px-3 py-2 text-[23px] text-slate-100'>
                                P
                            </div>
                            <div className='mx-1'>
                                <p className='mb-0 leading-3 text-[20px] font-bold'>Patka80</p>
                                <p className='mb-0'><span><CiIndent className='inline font-[500]' /></span> <span className='mx-1 text-sm font-[500]'>Netherland</span></p>
                            </div>
                        </div>
                        <div className='ml-0 md:ml-12 py-2'>
                ...
                <div className='flex flex-row justify-start items-start'>
                    <div className='w-[400px]'>
                        <div className='flex flex-row justify-start items-center'>
                            ...
                            <div className='mx-1'>
                                <p className='mb-0 leading-3 text-[20px] font-bold'>Jenni</p>
                                <p className='mb-0'><span><CiIndent className='inline font-[500]' /></span> <span className='mx-1 text-sm font-[500]'>United Kingdom</span></p>
                            </div>
                        </div>
                        <div className='ml-0 md:ml-12 py-2'>
                            <p className='mb-3'><span><TfiSupport className='inline' /></span> &nbsp; Superior Studio</p>
                    ...
                    <div className='w-full mb-0'>
                        <p className='mb-0 text-slate-400'>Reviewed: December 13, 2023</p>
                        <div className='w-full flex flex-row justify-between mb-0'>
                            <h3 className='mb-0'>Excelent Palce to Stay</h3>
                            <p className='w-[35px] h-[35px] bg-[#169239] px-2 py-2 rounded-lg text-slate-50'>10</p>
                        </div>
                        <div className='mb-0'>
